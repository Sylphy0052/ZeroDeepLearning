...
class MultiLayerNetExtend:
    ...
    Arguments:
        ...
        hidden_size_list {[type]} -- [description]
        output_size {[type]} -- [description]

    Keyword Arguments:
        activation {str} -- [description] (default: {'relu'})
        weight_init_std {str} -- [description] (default: {'relu'})
        weight_decay_lambda {int} -- [description] (default: {0})
        use_dropout {bool} -- [description] (default: {False})
        dropout_ration {float} -- [description] (default: {0.5})
        use_batchnorm {bool} -- [description] (default: {False})
    """

    def __init__(self, input_size, hidden_size_list,
                 output_size, activation='relu', weight_init_std='relu',
